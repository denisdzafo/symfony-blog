 ...
 */
final class Version20190505144011 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blogs ADD category_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_F41BCA7012469DE2 ON blogs');
        $this->addSql('ALTER TABLE blogs DROP category_id');
    }
}
